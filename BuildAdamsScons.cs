...
namespace MSCDevHelper
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class BuildAdamsScons
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BuildAdamsScons"/> class.
        /// Adds our command handlers for menu (commands must exist in the command table file)
        /// </summary>
        /// <param name="package">Owner package, not null.</param>
        private BuildAdamsScons(AsyncPackage package, OleMenuCommandService commandService)
        {
        ...
        /// </summary>
        public static BuildAdamsScons Instance
        {
            get;
            private set;
        }
